...
samplesDict['2016_z'] = [
    bm.JobConfig(
        ...
        nEvtPerJobIn1e6=nEvtPerJob, year="2016", isData=False, suffix='GenZAnalysis_DY50-amc_2016'),
]
...
samplesDict['2017_z'] = [
    bm.JobConfig(
        ...
        nEvtPerJobIn1e6=nEvtPerJob, year="2017", isData=False, suffix='GenZAnalysis_DY50-ext_2017'),    
]
...
samplesDict['2018_z'] = [
    bm.JobConfig(
        ...
        nEvtPerJobIn1e6=nEvtPerJob, year="2018", isData=False, suffix='GenZAnalysis_DY50-amc_2018'),
]
